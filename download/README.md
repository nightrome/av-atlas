...
Generated 2026-09-19 from <https://nightrome.github.io/av-atlas>.

## Files

| File | Rows | Contents |
| --- | --- | --- |
| `av-atlas-papers.csv.gz` | 25,749 | One row per AV-relevant paper. |
| `av-atlas-authorship.csv.gz` | 120,640 | Paper-to-author edges, with author position. |
| `av-atlas-citations.csv.gz` | 161,529 | In-corpus citation edges (citing -> cited). |
| `av-atlas-institutions.csv.gz` | 4,175 | Institutions with country, sector and totals. |
